    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 to-slate-100 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:flex flex-col justify-center bg-white/80 rounded-3xl p-8 shadow-xl border">
            <div className="mb-6">
            ...
            <div className="mt-8">
              <svg viewBox="0 0 200 120" className="w-full h-40" preserveAspectRatio="xMidYMid meet">
                <rect x="0" y="0" width="200" height="120" rx="12" fill="url(#g)" />
                <defs>
          ...
          {/* Right: Form card */}
          <div className="bg-white/95 rounded-3xl p-6 shadow-2xl border">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-xl font-semibold text-slate-800">{mode === "login" ? "Masuk ke Akun" : "Buat Akun Baru"}</h2>
